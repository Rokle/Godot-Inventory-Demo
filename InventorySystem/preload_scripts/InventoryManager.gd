...
func collect_items(inventory_id, collect_to):
	...
	var max_amount = ItemData.item_data[collect_to.content[0]]["max_amount"]
...
func swap_items(slot_1:Node, slot_2:Node,var button_pressed = "none"):
	...
	if button_pressed == "none":
		if slot_1.content[0] == "nothing":
			var max_amount = ItemData.item_data[slot_2.content[0]]["max_amount"]
		...
		elif slot_2.content[0] == "nothing":
			var max_amount = ItemData.item_data[slot_1.content[0]]["max_amount"]
		...
		if slot_1.content[0] == "nothing" and slot_2.content[1] != 0:
			slot_1.content = [slot_2.content[0], 1, slot_2.content[2]]
			slot_2.content[1] -= 1
		elif slot_2.content[0] == "nothing" and slot_1.content[1] != 0:
			con_holder = slot_1.content.duplicate()
